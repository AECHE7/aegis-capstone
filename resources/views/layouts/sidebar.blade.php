...
<aside class="sidebar" id="mainSidebar" role="complementary" aria-label="Application navigation sidebar">
    ...
    <div class="sidebar-footer">
        <form action="{{ route('logout') }}" method="POST" id="logoutForm">
            @csrf
            <button type="button" class="sidebar-logout-btn w-100 border-0 bg-transparent text-start" id="logoutLink" aria-label="Sign out of A.E.G.I.S.">
                <i class="fa-solid fa-right-from-bracket" style="min-width: 16px;" aria-hidden="true"></i>
