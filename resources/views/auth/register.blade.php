...
<head>
    ...
    <title>{{ \App\Models\Setting::get('app_name', 'A.E.G.I.S.') }} | Create Student Account</title>
...
<div class="text-center position-fixed top-50 start-50 translate-middle">
    <div class="spinner-border text-warning mb-2" role="status">
        <span class="visually-hidden">Loading Registration Portal...</span>
    </div>
    <p class="text-muted small fw-semibold">Opening Registration Portal...</p>
</div>
