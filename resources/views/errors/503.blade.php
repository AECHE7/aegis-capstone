...
<head>
    ...
    <title>503 — System Maintenance | A.E.G.I.S.</title>
...
<body>
    <div class="error-card">
        <div class="badge-code">Maintenance Mode</div>
        <div class="icon-wrapper">
            <i class="fa-solid fa-screwdriver-wrench"></i>
        </div>
        <h1>System Upgrades in Progress</h1>
        <p>A.E.G.I.S. is temporarily performing routine maintenance and server synchronization. Services will resume shortly.</p>
