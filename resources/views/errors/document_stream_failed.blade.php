...
<head>
    ...
    <style>
        ...
        svg { width: 48px; height: 48px; color: #ef4444; margin-bottom: 12px; }
...
<body>
    ...
    <h3>{{ $title ?? "Remote Stream Failed" }}</h3>
    <p>{{ $description ?? "Could not stream the document from cloud storage. Please check connection." }}</p>
</body>
</html>