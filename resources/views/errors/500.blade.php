...
<head>
    ...
    <title>500 — Internal Server Error | A.E.G.I.S.</title>
...
<body>
    <div class="error-card">
        <div class="badge-code">Server Error 500</div>
        <div class="icon-wrapper">
            <i class="fa-solid fa-triangle-exclamation"></i>
        </div>
        <h1>Something Went Wrong</h1>
        <p>An unexpected server-side condition was encountered while processing your request. The administrative event log has captured this occurrence.</p>
