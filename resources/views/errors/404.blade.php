...
<head>
    ...
    <title>404 — Page Not Found | A.E.G.I.S.</title>
    ...
    <style>
        ...
        .error-card {
            ...
            width: 100%;
            text-align: center;
            box-shadow: 0 20px 45px rgba(12, 78, 45, 0.08), 0 2px 8px rgba(0, 0, 0, 0.04);
        ...
        .error-card::before {
            ...
            right: 0;
            height: 6px;
            background: linear-gradient(90deg, var(--clsu-green), var(--clsu-gold));
        }
...
<body>
    <div class="error-card">
        <div class="badge-code">Error 404</div>
        <div class="icon-wrapper">
            <i class="fa-solid fa-compass"></i>
        </div>
        <h1>Page Not Found</h1>
        <p>The scholarship portal page or document you are looking for does not exist, has been archived, or was moved to a new destination.</p>
